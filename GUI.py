...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowIcon(QtGui.QIcon("images/tray_icon.png"))

        self.tray_icon = QSystemTrayIcon(self)
        self.tray_icon.setIcon(QtGui.QIcon("images/tray_icon.png"))
        ...
        self.now_clicked = 0
        self.button_clicked(0, self.hero_list[0])
        stereoKeyBind()
    ...
    def new_button(self, i, j, name):
        ...
        self.button_list[j].clicked.connect(lambda: self.button_clicked(j, name))
        self.button_list[j].setIcon(QtGui.QIcon('images/{}.png'.format(name)))
    ...
    def button_clicked(self, j, name):
        print(j)
        self.button_list[self.now_clicked].setIcon(
            QtGui.QIcon('images/{}.png'.format(self.hero_list[self.now_clicked])))
        self.now_clicked = j
        self.button_list[j].setIcon(QtGui.QIcon('images/{}_active.png'.format(name)))
        self.button_list[j].setIcon(QtGui.QIcon('images/{}_active.png'.format(name)))
        heroKeyBind(10, name)
